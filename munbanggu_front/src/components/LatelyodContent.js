...
const LatelyodContent = (props) => {
    console.log(props);
    const date = props.createdAt.substr(0, 10);
    return (
        <React.Fragment>
            <Wrap>
                <Tbody>
                    <Tr>
                        <Tdleft>
                            <PickAddCont>
                                <OrderGoodsNum>
                                    <Strong>구매날짜:{date}</Strong>
                                </OrderGoodsNum>
                                <SpanImg>
                                    <AproductImg>
                                        <Img width="80" src={props.goods.thumbnail_url} />
                                    </AproductImg>
                                </SpanImg>
                                <PickAddInfo>
                                    <AproductName>
                                        {/* <EmName>{props.goods.title}</EmName> */}
                                    </AproductName>
                                </PickAddInfo>
                            </PickAddCont>
                        </Tdleft>
                        ...
                        <Td>
                            <OrderGoodsNum>
                                <Strong>{props.quantity}개</Strong>
                            </OrderGoodsNum>
                        </Td>

                        <Td>
                            <StrongPrice>{props.goods.sale_price * props.quantity}원</StrongPrice>
                        </Td>
                    </Tr>
                </Tbody>
            </Wrap>
